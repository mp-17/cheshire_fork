...
#define CHESHIRE_HW_FEATURES_REG_OFFSET 0x4c
...
#define CHESHIRE_HW_FEATURES_AXIRT_BIT 9
#define CHESHIRE_HW_FEATURES_CLIC_BIT 10
#define CHESHIRE_HW_FEATURES_IRQ_ROUTER_BIT 11

// Total size of LLC in bytes
#define CHESHIRE_LLC_SIZE_REG_OFFSET 0x50

// VGA hardware parameters
#define CHESHIRE_VGA_PARAMS_REG_OFFSET 0x54
...
// STUB - Throw an exception every (stub_ex_rate + 1) mmu requests
